...
H['output_dir'] = 'output_dir/gold_deep_prio3_20channel' #cross_crop_retrain_zrot
H['predictions_dir'] = ''

H['allow_soft_placement'] = True
H['log_device_placement'] = False
H['max_steps'] = 15#100000
...
H['train_lst'] = '/media/niklas/Data_3/dsb3/datapipeline_gen9/LUNA16_0/interpolate_candidates/tr_candidates_binary.lst'
H['val_lst'] = '/media/niklas/Data_3/dsb3/datapipeline_gen9/LUNA16_0/interpolate_candidates/va_candidates_binary.lst'
...
H['save_step'] = 5 # saving checkpoint
