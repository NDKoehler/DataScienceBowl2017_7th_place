...
from  architectures.model_def.classifier3D import classifier3D_graph

TOWER_NAME = 'tower'


def load_classifier3D(
    ...
    with slim.arg_scope([slim.conv2d, slim.conv2d_transpose, slim.fully_connected]):
        ...
        with slim.arg_scope([slim.conv2d],
            ...
            with slim.arg_scope([slim.conv2d_transpose],
                    ...
                    logits, endpoints = classifier3D_graph(kwargs=kwargs, inputs=images,
...
def classifier3D(data, num_classes=2, restore_logits=False, is_training=True, scope='classifier3D', reuse=None, **kwargs):
    # Load inception graph
    images = data['images']
    logits, endpoint = load_classifier3D(
    ...
    return {'logits': logits, 'predictions': endpoint['predictions']}, endpoint
