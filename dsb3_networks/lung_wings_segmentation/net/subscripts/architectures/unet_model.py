...
from subscripts.architectures.model_def.unet_graph import unet_graph
    ...
    with slim.arg_scope([slim.conv2d, slim.conv2d_transpose]):
        ...
        with slim.arg_scope([slim.conv2d],
            ...
            with slim.arg_scope([slim.conv2d_transpose],
                ...
                logits, endpoints = unet_graph(kwargs=kwargs, inputs=images,
...
def unet(data, num_classes=2, restore_logits=False, is_training=True, scope='unet', reuse=None, **kwargs):
