...
from subscripts.architectures.model_def.unet_graph2D3D import unet_graph2D3D
    ...
    with slim.arg_scope([slim.conv2d, slim.conv2d_transpose]):
        ...
        with slim.arg_scope([slim.conv2d],
            ...
            with slim.arg_scope([slim.conv2d_transpose],
                ...
                logits, endpoints = unet_graph2D3D(kwargs=kwargs, inputs=images,
...
def unet2D3D(data, num_classes=2, restore_logits=False, is_training=True, scope='unet2D3D', reuse=None, **kwargs):
    # Load inception graph
    images = data['images']
    logits, endpoint = load_unet(
    ...
    return {'logits': logits, 'probs': tf.nn.sigmoid(logits)}, endpoint
